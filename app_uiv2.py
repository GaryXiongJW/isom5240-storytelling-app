...
UNSAFE_KEYWORDS = {
    ...
    "weapon", "weapons", "dead", "death", "die", "died", "dying", "scary",
    "scare", "scared", "horror", "terror", "violent", "violence", "war",
...
def inject_kid_theme():
    st.markdown(
        ...
        .pic-frame { height:360px; border-radius:32px; border:6px solid #fff;
        ...
        .pic-placeholder { text-align:center; padding:1.2rem; color:#5a189a;
          font-weight:800; font-size:1.55rem; line-height:1.35; }
        .pic-frame img { width:100%; height:100%; object-fit:cover; }
        div[data-testid="stFileUploader"] { background:rgba(255,255,255,0.75);
          border-radius:20px; padding:0.4rem 0.6rem; border:3px dashed #ff85a1; }
        div[data-testid="stFileUploader"] section { min-height:70px !important; max-height:70px !important; }
...
def main():
    ...
    with left:
        uploaded = st.file_uploader(
            "Drop a picture here", type=["jpg", "jpeg", "png"],
            label_visibility="collapsed",
        )
        if uploaded is None:
            st.markdown(
                """
                <div class="pic-frame"><div class="pic-placeholder">
